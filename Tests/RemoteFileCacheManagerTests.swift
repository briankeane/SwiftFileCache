...
class RemoteFileCacheManagerTests: QuickSpec
{
    override func spec()
    {
        describe("RemoteFileCacheManagerTests")
        {
            ...
            var AudioFileCacheInstance:AudioFileCacheMonitorService = AudioFileCacheMonitorService()
            ...
            beforeEach
            {
                ...
                AudioFileCacheInstance = AudioFileCacheMonitorService()
            }
            ...
            {
                expect(AudioFileCacheInstance.isCached("bob.mp3")).to(equal(false))
            }
            ...
            it ("returns true for a cached file")
            {
                ...
                expect(AudioFileCacheInstance.isCached("bob.mp3")).to(equal(true))
            }
